...
<Frame caption="The asset library panel">
  <img src="/images/infinite-canvas/asset-library-01.png" alt="Asset library showing the workspace folder tree and dataset cards with their action menus" />
</Frame>
...
<Frame caption="The node history picker">
  <img src="/images/infinite-canvas/node-history-picker-01.png" alt="History picker listing every result a node has produced, with one promoted as the main output" />
</Frame>
