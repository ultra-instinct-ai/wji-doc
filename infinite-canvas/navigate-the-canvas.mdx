...
<Frame caption="The viewport control bar">
  <img src="/images/infinite-canvas/viewport-bar-01.png" alt="Viewport control bar showing undo, redo, zoom out, zoom percentage, zoom in, fit, minimap toggle, and performance mode" />
</Frame>
...
<Frame caption="The minimap, colored by node tag">
  <img src="/images/infinite-canvas/minimap-01.png" alt="Minimap in the corner of the canvas showing node positions in several tag colors" />
</Frame>
