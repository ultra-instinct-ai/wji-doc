...
<Frame caption="The generate panel">
  <img src="/images/infinite-canvas/generate-panel-01.png" alt="Generate panel below a node with the prompt box, model selector, parameters button, reference list, cost estimate, and send button" />
</Frame>
...
<Frame caption="Generation parameters on the canvas">
  <img src="/images/infinite-canvas/generate-params-01.png" alt="Generation parameters popover with aspect ratio, batch size, and model specific settings" />
</Frame>
...
<Frame caption="The bulk submit review dialog">
  <img src="/images/infinite-canvas/bulk-review-01.png" alt="Review dialog listing each selected node with its prompt, references, model, and parameters before submitting" />
</Frame>
