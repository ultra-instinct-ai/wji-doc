...
<Frame caption="Dragging from a connection handle">
  <img src="/images/infinite-canvas/connection-handles-01.png" alt="A node with plus handles on both sides and a connection line being dragged toward a generation node" />
</Frame>
...
<Frame caption="The reference list on a generation node">
  <img src="/images/infinite-canvas/reference-list-01.png" alt="Reference list showing connected assets with names, a usage counter, and drag handles for reordering" />
</Frame>
...
<Frame caption="Cutting a connection">
  <img src="/images/infinite-canvas/cut-connection-01.png" alt="A selected connection line with the scissors button showing at its midpoint" />
</Frame>
