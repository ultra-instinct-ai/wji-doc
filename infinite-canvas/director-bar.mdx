...
<Frame caption="The director bar along the bottom of the canvas">
  <img src="/images/infinite-canvas/director-bar-01.png" alt="Director bar timeline with several clips in order, playback controls, and the export menu" />
</Frame>
...
<Frame caption="The export menu">
  <img src="/images/infinite-canvas/director-export-01.png" alt="Export menu offering export video, export project as NLE, and download all media" />
</Frame>
