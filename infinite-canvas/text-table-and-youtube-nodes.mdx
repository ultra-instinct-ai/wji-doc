...
<Frame caption="A text node and its toolbar">
  <img src="/images/infinite-canvas/text-node-toolbar-01.png" alt="Text node showing rendered Markdown with a toolbar offering AI assistant, formatting, import, and download" />
</Frame>
...
<Frame caption="Column mapping on a table node">
  <img src="/images/infinite-canvas/table-field-mapping-01.png" alt="Table node with the field mapping control showing which column is the text and which is the prompt" />
</Frame>
