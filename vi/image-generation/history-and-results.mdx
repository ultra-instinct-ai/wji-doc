...
<Frame caption="Cấu tạo của một mục lịch sử">
  ![Mục lịch sử hiển thị chế độ, mô hình, tỷ lệ khung hình, seed, credit đã tính, câu lệnh cuối và hình thu nhỏ tham chiếu](/images/Screenshot-2026-09-07-at-11.38.08.png)
</Frame>
...
<Frame caption="Menu thao tác trên một kết quả">
  ![Menu thao tác trên một ảnh được tạo với tải xuống, mô tả, sửa lại, thêm tham chiếu, đặt khung và lưu](/images/9月1日\(78\).gif)
</Frame>
