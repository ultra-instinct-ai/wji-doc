...
<Frame caption="Các túi credit và ngày hết hạn của chúng">
  <img src="/images/billing/balance-card-01.png" alt="Thẻ số dư đã mở rộng để hiển thị từng túi credit với số còn lại và ngày hết hạn" />
</Frame>
...
<Frame caption="Tab tiêu thụ">
  <img src="/images/billing/usage-consumption-01.png" alt="Bảng tiêu thụ với các cột biến động credit, giảm giá và hoàn tiền, cùng bộ lọc ngày, mô hình và không gian làm việc" />
</Frame>
