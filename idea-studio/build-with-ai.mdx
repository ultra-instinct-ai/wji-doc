...
<Frame caption="Choosing what Build with AI should produce">
  <img src="/images/idea-studio/build-with-ai-01.png" alt="Build with AI dialog with the reference selector, inspiration box, and the six output checkboxes" />
</Frame>
...
<Frame caption="Reviewing results before they are saved">
  <img src="/images/idea-studio/build-with-ai-review-01.png" alt="Editable results table with per-card toggles, a target folder selector, and status badges" />
</Frame>
