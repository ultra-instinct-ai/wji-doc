...
<Frame caption="Reference images with their types set">
  <img src="/images/image-generation/reference-block-01.png" alt="Reference block with several cards, each labelled by type such as character, location, and style" />
</Frame>
