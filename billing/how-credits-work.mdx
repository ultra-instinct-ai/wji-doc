...
<Frame caption="The estimate on the generate button">
  <img src="/images/billing/cost-estimate-01.png" alt="Generate button carrying its credit estimate, beside a per-second rate shown for a model with automatic duration" />
</Frame>
