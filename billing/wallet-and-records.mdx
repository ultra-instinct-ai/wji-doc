...
<Frame caption="Credit buckets and their expiry dates">
  <img src="/images/billing/balance-card-01.png" alt="Balance card expanded to show each credit bucket with its remaining amount and expiry date" />
</Frame>
...
<Frame caption="The consumption tab">
  <img src="/images/billing/usage-consumption-01.png" alt="Consumption table with credit change, discount, and refund columns, and the date, model, and workspace filters" />
</Frame>
